...
INSERT INTO "new_User" ("class", "crdate", "id", "id_account", "id_alliance", "id_role", "idvk", "medal", "name", "private", "spec") SELECT "class", "crdate", "id", "id_account", "id_alliance", "id_role", "idvk", "medal", "name", "private", "spec" FROM "User";
DROP TABLE "User";
