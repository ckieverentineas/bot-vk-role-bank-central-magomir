...
INSERT INTO "new_AllianceCoin" ("converted", "converted_point", "course_coin", "course_medal", "id", "id_alliance", "name", "point", "smile") SELECT "converted", "converted_point", "course_coin", "course_medal", "id", "id_alliance", "name", "point", "smile" FROM "AllianceCoin";
