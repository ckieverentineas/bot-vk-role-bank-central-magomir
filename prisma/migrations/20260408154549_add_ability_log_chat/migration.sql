...
INSERT INTO "new_Alliance" ("hidden", "id", "id_chat", "id_chat_monitor", "id_chat_shop", "id_chat_topic", "idvk", "name") SELECT "hidden", "id", "id_chat", "id_chat_monitor", "id_chat_shop", "id_chat_topic", "idvk", "name" FROM "Alliance";
DROP TABLE "Alliance";
