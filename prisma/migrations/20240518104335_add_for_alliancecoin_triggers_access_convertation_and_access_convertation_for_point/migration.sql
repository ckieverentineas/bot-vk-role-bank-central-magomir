...
INSERT INTO "new_AllianceCoin" ("course_coin", "course_medal", "id", "id_alliance", "name", "point", "smile") SELECT "course_coin", "course_medal", "id", "id_alliance", "name", "point", "smile" FROM "AllianceCoin";
