...
import { Topic_Rank_V2_Custom_Period, Topic_Rank_V2_Custom_Period_Process, Topic_Rank_V2_Enter, Topic_Rank_V2_Search_Topic, Topic_Rank_V2_Search_Topic_Process, Topic_Rank_V2_Select_Facult, Topic_Rank_V2_Select_Hashtag, Topic_Rank_V2_Select_Monitor, Topic_Rank_V2_Weeks } from './engine/events/module/topic_rank_v2';
...
initializeGroupId().then(async () => {
    ...
    vk.updates.on('message_new', async (context: any, next: any) => {
        ...
        const isCustomPeriodResponse = await Topic_Rank_V2_Custom_Period_Process(context);
        if (isCustomPeriodResponse) {
            return;
        }
